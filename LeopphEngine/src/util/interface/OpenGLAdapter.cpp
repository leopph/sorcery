...
{
#ifdef _DEBUG
	Bimap<int, ShaderType, ShaderTypeHash, ShaderTypeEqual, true> OpenGLAdapter::s_ShaderTypes
#else
	Bimap<int, ShaderType, ShaderTypeHash, ShaderTypeEqual> OpenGLAdapter::s_ShaderTypes;
#endif
	{
