...
namespace leopph::implementation
{
	...
	void Shader::SetUniform(const std::string& name, const Matrix4& value) const { glUniformMatrix4fv(glGetUniformLocation(m_ID, name.data()), 1, GL_FALSE, value.Transposed().Data()); }
