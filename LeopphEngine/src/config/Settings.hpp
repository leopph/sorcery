...
namespace leopph
{
	...
	public:
		...
		static LEOPPHAPI const Vector2& DirectionalLightShadowMapResolution();
		static LEOPPHAPI void DirectionalLightShadowMapResolution(const Vector2& newRes);
	...
	private:
		...
		static Vector2 s_DirectionalLightShadowMapResolution;
