...
namespace leopph
{
	...
	class Settings
	{
		public:
			...
			// More values provide better transitions but also require more VRAM.
			[[nodiscard]] inline static auto DirectionalShadowMapResolutions() -> const auto&;
			...
			[[nodiscard]] LEOPPHAPI static auto DirectionalShadowCascadeCount() -> std::size_t;
			...
			// Higher values produce sharper shadows but require more VRAM.
			// More values provide better transitions but also require more VRAM.
			LEOPPHAPI static auto DirectionalShadowMapResolutions(std::vector<std::size_t> newRess) -> void;
	...
	inline auto Settings::DirectionalShadowMapResolutions() -> const auto&
	{
