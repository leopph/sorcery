...
namespace leopph
{
	...
	class EventReceiver : public internal::EventReceiverBase
	{
		public:
			...
			LEOPPHAPI auto operator=(const EventReceiver& other) -> EventReceiver& = default;
			LEOPPHAPI auto operator=(EventReceiver&& other) -> EventReceiver& = default;
			...
			auto Handle(EventReceiverBase::EventParamType event) const -> void override
			{
		...
		private:
			...
			LEOPPHAPI virtual auto OnEventReceived(EventParamType event) -> void = 0;
	};
}
