...
namespace leopph
{
	...
	class Transform final : public Component
	{
		public:
			...
			[[nodiscard]]
			LEOPPHAPI auto Parent() const -> Transform*;
			...
			LEOPPHAPI auto Children() const -> const std::unordered_set<Transform*>&;
