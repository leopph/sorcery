...
auto EditorApp::SetGuiDarkMode(bool const darkMode) noexcept -> void {
  ...
  if (darkMode) {
    ...
    colors[ImGuiCol_CheckMark] = ImVec4(0.38f, 0.44f, 0.49f, 1.00f);
    ...
    colors[ImGuiCol_HeaderHovered] = ImVec4(0.14f, 0.16f, 0.18f, 1.00f);
    colors[ImGuiCol_HeaderActive] = ImVec4(0.14f, 0.16f, 0.18f, 1.00f);
    ...
    colors[ImGuiCol_TabHovered] = ImVec4(0.12f, 0.14f, 0.16f, 1.00f);
    colors[ImGuiCol_Tab] = ImVec4(0.12f, 0.14f, 0.16f, 1.00f);
    colors[ImGuiCol_TabSelected] = ImVec4(0.12f, 0.14f, 0.16f, 1.00f);
