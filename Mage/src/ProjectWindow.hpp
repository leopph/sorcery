...
class ProjectWindow {
  ...
  static auto SaveNewNativeAsset(Context& context, std::unique_ptr<NativeResource> asset, std::string_view targetAssetFileName, std::filesystem::path const& selectedDirAbs) -> void;
