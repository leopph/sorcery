...
# Fix Assimp's hardcoded expectation that FetchContent puts
# tinyusdz under ${CMAKE_BINARY_DIR}/_deps.
if("usd" IN_LIST FEATURES)
    vcpkg_replace_string(
        "${SOURCE_PATH}/code/CMakeLists.txt"
...
if("usd" IN_LIST FEATURES)
    vcpkg_from_github(
        OUT_SOURCE_PATH TINYUSDZ_SOURCE_PATH
        REPO lighttransport/tinyusdz
        REF "6050eef932f7d2788656d63297aa488fb0961ed1"
        SHA512 e8cbb0c5cba5b235ede325e891a4db41ade73f352421a50d6258324fe7b108d7735870b0f4fe91a59ce05822ea927e9a127c796fb2b2fb4dd75c74b15bcd021e
    )

    list(APPEND USD_OPTIONS
        "-DFETCHCONTENT_SOURCE_DIR_TINYUSDZ_REPO=${TINYUSDZ_SOURCE_PATH}"
    )
endif()
...
vcpkg_cmake_configure(
    ...
    OPTIONS
        ...
        -DASSIMP_BUILD_USD_VERBOSE_LOGS=ON
        ${FEATURE_OPTIONS}
        ${USD_OPTIONS}
)
