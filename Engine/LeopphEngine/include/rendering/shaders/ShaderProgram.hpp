...
namespace leopph
{
	...
	{
		public:
			explicit ShaderProgram(ShaderProgramSourceInfo const& sourceInfo);
		...
		private:
			...
			[[nodiscard]] static std::optional<std::string> compile_shader(u32 shader, std::span<std::string const> lines);
