...
{
	GlSpotShadowMap::GlSpotShadowMap() :
	...
	auto GlSpotShadowMap::Clear() const noexcept -> void
	{
	...
	auto GlSpotShadowMap::BindForWriting() const noexcept -> void
	{
	...
	auto GlSpotShadowMap::BindForWritingAndClear() const -> void
	{
		BindForWriting();
		Clear();
	}
	...
	auto GlSpotShadowMap::BindForReading(ShaderProgram& shader, std::string_view const uniformName, GLuint const texUnit) const -> GLuint
	{
	...
	auto GlSpotShadowMap::OnEventReceived(EventParamType event) -> void
	{
	...
	auto GlSpotShadowMap::ConfigureShadowMap() -> void
	{
		m_ShadowMap = {};
