...
{
	GlCubeShadowMap::GlCubeShadowMap() :
	...
	auto GlCubeShadowMap::Clear() const noexcept -> void
	{
	...
	auto GlCubeShadowMap::BindForWriting(GLint const face) const noexcept -> void
	{
	...
	auto GlCubeShadowMap::BindForWritingAndClear(GLint const face) const -> void
	{
		BindForWriting(face);
		Clear();
	}
	...
	auto GlCubeShadowMap::BindForReading(ShaderProgram& shader, std::string_view const uniformName, GLuint const texUnit) const -> GLuint
	{
	...
	auto GlCubeShadowMap::OnEventReceived(EventParamType event) -> void
	{
	...
	auto GlCubeShadowMap::ConfigCubeMap() -> void
	{
		m_Cubemap = {};
