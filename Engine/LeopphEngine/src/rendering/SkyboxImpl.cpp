...
namespace leopph::internal
{
	...
	void SkyboxImpl::draw(gsl::not_null<ShaderProgram const*> const shader) const
	{
	...
	std::filesystem::path const& SkyboxImpl::left_path() const
	{
	...
	std::filesystem::path const& SkyboxImpl::right_path() const
	{
	...
	std::filesystem::path const& SkyboxImpl::top_path() const
	{
	...
	std::filesystem::path const& SkyboxImpl::bottom_path() const
	{
	...
	std::filesystem::path const& SkyboxImpl::front_path() const
	{
	...
	std::filesystem::path const& SkyboxImpl::back_path() const
	{
	...
	std::filesystem::path const& SkyboxImpl::AllPaths() const
	{
		return mAllPaths;
	}
	...
	std::filesystem::path SkyboxImpl::build_all_paths(std::filesystem::path const& left, std::filesystem::path const& right, std::filesystem::path const& top, std::filesystem::path const& bottom, std::filesystem::path const& front, std::filesystem::path const& back)
	{
		return right.string()
	...
	void SkyboxImpl::register_handle(Skybox const* const handle)
	{
	...
	void SkyboxImpl::unregister_handle(Skybox const* const handle)
	{
	...
	u64 SkyboxImpl::num_handles() const
	{
