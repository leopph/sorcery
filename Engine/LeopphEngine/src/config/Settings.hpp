...
namespace leopph
{
	...
	class Settings final : public EventReceiver<internal::FrameCompleteEvent>, public EventReceiver<internal::WindowEvent>
	{
		public:
			...
			[[nodiscard]] constexpr
			auto ShaderCachePath() noexcept -> auto const&;
			...
			[[nodiscard]] constexpr
			auto DirShadowResolution() -> auto const&;
			...
			// Higher values produce better quality shadows but increase VRAM and computation costs.
			LEOPPHAPI
			auto DirShadowResolution(std::span<std::size_t const> cascades) -> void;
		...
		private:
			...
			constexpr static char const* JSON_SHADER_LOC = "shaderCacheLoc";
			constexpr static char const* JSON_DIR_SHADOW_RES = "dirShadowRes";
			constexpr static char const* JSON_SPOT_SHADOW_RES = "spotShadowRes";
			constexpr static char const* JSON_POINT_SHADOW_RES = "pointShadowRes";
			constexpr static char const* JSON_MAX_SPOT = "numMaxSpot";
			constexpr static char const* JSON_MAX_POINT = "numMaxPoint";
			constexpr static char const* JSON_API = "api";
			constexpr static char const* JSON_PIPE = "pipeline";
			constexpr static char const* JSON_DIR_CORRECT = "dirShadowCascadeCorrection";
			constexpr static char const* JSON_VSYNC = "vsync";
			constexpr static char const* JSON_RES_W = "resW";
			constexpr static char const* JSON_RES_H = "resH";
			constexpr static char const* JSON_REND_MULT = "resMult";
			constexpr static char const* JSON_FULLSCREEN = "fullscreen";
	};


	constexpr auto Settings::ShaderCachePath() noexcept -> auto const&
	{
	...
	constexpr auto Settings::SetGraphicsApi(GraphicsApi const newApi) noexcept
	{
	...
	constexpr auto Settings::SetGraphicsPipeline(GraphicsPipeline const pipeline) noexcept
	{
	...
	constexpr auto Settings::DirShadowResolution() -> auto const&
	{
	...
	constexpr auto Settings::DirShadowCascadeCorrection(float const newCor) noexcept
	{
	...
	constexpr auto Settings::MaxSpotLightCount(std::size_t const newCount) noexcept
	{
	...
	constexpr auto Settings::MaxPointLightCount(std::size_t const newCount) noexcept
	{
