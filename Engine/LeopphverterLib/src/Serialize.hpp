...
namespace leopph::convert
{
	...
	LEOPPHAPI auto Serialize(float f, std::vector<uint8_t>& oBuf, std::endian endianness) -> void;
	LEOPPHAPI auto Serialize(double d, std::vector<uint8_t>& oBuf, std::endian endianness) -> void;
	...
	LEOPPHAPI auto Serialize(Color const& color, std::vector<uint8_t>& oBuf, std::endian endianness) -> void;

	LEOPPHAPI auto Serialize(Material const& mat, std::vector<uint8_t>& oBuf, std::endian endianness) -> void;
}
