...
enum class ColorEncoding : u8 {
  Linear = 0,
  // The color values are in linear RGB space
  sRGB = 1,
  // The color values are in non-linear sRGB color space
};
...
enum class ImageOrientation : u8 {
  Original = 0,
  // Data will be stored as given
  FlipVertical = 1,
  // Data will be stored as if read line-by-line bottom up
};
