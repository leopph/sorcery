...
auto ManagedRuntime::StartUp() -> void {
	...
	mono_add_internal_call("leopph.Input::get_CursorPosition", reinterpret_cast<void*>(&Call<gWindow, &Window::GetCursorPosition>));
	mono_add_internal_call("leopph.Input::get_MouseDelta", reinterpret_cast<void*>(&Call<gWindow, &Window::GetMouseDelta>));
	mono_add_internal_call("leopph.Input::get_IsCursorLocked", reinterpret_cast<void*>(&managedbindings::IsWindowCursorLocked<gWindow>));
	mono_add_internal_call("leopph.Input::LockCursor", reinterpret_cast<void*>(&managedbindings::LockCursor<gWindow>));
	mono_add_internal_call("leopph.Input::UnlockCursor", reinterpret_cast<void*>(&managedbindings::UnlockCursor<gWindow>));
